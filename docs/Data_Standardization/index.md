...
### Dataset content summary  (Metadata, or how to make it seen by Fairsharing.org)
...
* **standardized data components**: If anticipated early in the project design cycle, standardised data components (e.g. [ISO Geographic entity](), [Cell Ontology line reference]()) may be incorporated directly into a project’s primary data schema itself.
